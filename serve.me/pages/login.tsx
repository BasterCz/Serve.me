    ...
    <div>
      ...
      <style jsx global>{`
          body {
            ...
            background-image: linear-gradient( rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8) ), url('/pexels-monicore-1391487.jpg');
          }
        `}</style>
            ...
            <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
              <form>
                <div className="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                  <p className="lead fw-normal mb-0 me-3 title-me">Přihlášení</p>
                </div>
                ...
                <div className="text-center text-lg-start mt-4 pt-2 d-grid gap-2">
                  <button
                    type="button"
                    className="btn btn-danger btn-lg boton"
